...
onblur="if(this.value=='')(this.value='Music, Musicial, Album, tribus music list')" />
					...
					<div id="social_media">
						...
						<div id="social_lftcol">
							<a href="#"><img src="${path1}activity/img/icon_facebook.jpg" alt="" />
							</a>
							<a href="#"><img src="${path1}activity/img/icon_tweet.jpg" alt="" />
							</a>
						</div>
						<div id="social_box">
							<!--start social_box-->
							<div id="message">
								...
								<a href="#"><img src="${path1}activity/img/icon_message3.jpg" alt="" />
								</a>
								<a href="#"><img src="${path1}activity/img/icon_message4.jpg" alt="" />
								</a>
							</div>
							<div class="address">
								<h3>
														...
														<div class="feature_info">
															...
															<div class="feature_social">
																<div class="feature_icon">
																	<a href="#"><img src="${path1}activity/img/icon_feature1.png" alt="" />
																	</a>
																	<a href="#"><img src="${path1}activity/img/icon_feature2.png" alt="" />
																	</a>
																</div>
