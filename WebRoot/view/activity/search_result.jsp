             ...
             ${item}
                    ...
                    <div id="search_rgt"><!--start search_rgt-->
                    	<div class="search_widget"><!--start search_widget-->
                        	<img src="${path1}activity/img/pic_search_widget1.jpg" alt="" />
                        </div><!--//end .search_widget-->
                        <div class="search_widget"><!--start search_widget-->
                        	<img src="${path1}activity/img/pic_search_widget2.jpg" alt="" />
                        </div><!--//end .search_widget-->
                        <div class="search_widget"><!--start search_widget-->
                        	<img src="${path1}activity/img/pic_search_widget3.jpg" alt="" />
                        ...
                        <div class="search_widget"><!--start search_widget-->
                        	<img src="${path1}activity/img/pic_search_widget4.jpg" alt="" />
                        ...
                        <div class="search_widget"><!--start search_widget-->
                        	<img src="${path1}activity/img/pic_search_widget5.jpg" alt="" />
